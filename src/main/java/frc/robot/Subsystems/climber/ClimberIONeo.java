...
public class ClimberIONeo implements ClimberIO {
  ...
  public ClimberIONeo() {
    ...
    climberLeftMotor = new SparkMax(ClimberConstants.RIGHT_CANID, MotorType.kBrushless);
  ...
  public void updateInputs(ClimberIOInputs inputs) {
    ...
    inputs.climberAppliedVolts = climberLeftMotor.getAppliedOutput() * climberLeftMotor.getBusVoltage() + climberRightMotor.getAppliedOutput() * climberRightMotor.getBusVoltage();
    /**
    ...
    inputs.climberPositionRad = Units.rotationsToRadians(climberLeftEncoder.getPosition())/ClimberConstants.GEAR_RATIO;
    /** Returns the position of the climber Motor by how many degrees it has rotated */
    inputs.climberPositionDeg = Units.rotationsToDegrees(climberLeftEncoder.getPosition())/ClimberConstants.GEAR_RATIO;
    /** Returns the velocity of the climber Motor by how many radians per second it has rotated */
    inputs.climberVelocityRadPerSec = Units.rotationsPerMinuteToRadiansPerSecond(climberLeftEncoder.getVelocity())/ClimberConstants.GEAR_RATIO;
    /** The Current Drawn from the climber Motor in Amps */
    inputs.climberCurrentAmps = new double[] {climberLeftMotor.getOutputCurrent(),climberRightMotor.getOutputCurrent()};
    /** The tempature of the climber Motor in Celsius */
    inputs.climberTempCelsius = new double[] {climberLeftMotor.getMotorTemperature(), climberRightMotor.getMotorTemperature()};
  }
