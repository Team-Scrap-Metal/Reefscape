...
public class Elevator extends SubsystemBase {
  ...
  ElevatorControls.PID_TOLERANCE_M = SmartDashboard.getNumber("ElevatorTolerance", ElevatorControls.PID_TOLERANCE_M);
  ElevatorControls.MAX_VELOCITY = SmartDashboard.getNumber("ElevatorMaxVel", ElevatorControls.MAX_VELOCITY);
  ElevatorControls.MAX_ACCELERATION = SmartDashboard.getNumber("ElevatorMaxAccell", ElevatorControls.MAX_ACCELERATION);
