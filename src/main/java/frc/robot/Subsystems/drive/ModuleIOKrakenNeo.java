...
public class ModuleIOKrakenNeo implements ModuleIO {
  ...
  public ModuleIOKrakenNeo(int index) {
    ...
    config.inverted(isTurnMotorInverted).idleMode(IdleMode.kBrake).smartCurrentLimit(40, 40);
  ...
  public void setDriveBrakeMode(boolean enable) {
    // turnSparkMax.setIdleMode(enable ? IdleMode.kBrake : IdleMode.kCoast); //TODO: Remake Command
  }
